...
// Every level returns the same row shape (campaigns add accountName/hasMatches),
// so one presentational row component covers the whole tree.
export type ManagerLedgerRow = ManagerAdSetRow;
